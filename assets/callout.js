...
let info_sessions = [
    ...
    {date:{month: 9,day: 9},time:{hour: 18,minute: 0},committee:'Social',location:'Coming Soon'},
    {date:{month: 9,day: 9},time:{hour: 18,minute: 0},committee:'Industrial Relations',location:'Coming Soon'},
    {date:{month: 9,day: 9},time:{hour: 18,minute: 0},committee:'Growth &amp; Engagement',location:'Coming Soon'},
