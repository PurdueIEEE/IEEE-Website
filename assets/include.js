            ...
            <ul class="navbar-nav ms-auto mb-2">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarlinks_committees">
                    ...
                    <li><a class="dropdown-item" href="/neurotech">Neurotech</a></li>
    ...
    <footer>
        ...
        <div class="container-fluid text-center py-3">
            <div class="row justify-content-center">
                ...
                <a href="https://youtube.com/@PurdueIEEE" target="_blank" class="link-dark"><i class="bi bi-youtube fs-1 mx-2"></i></a>
...
if (location.hostname === "purdueieee.org") {
  ...
  })(window,document,'script','//www.googletagmanager.com/gtag/js?id=G-E3YRT96GPT','gtag');

  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-E3YRT96GPT')
